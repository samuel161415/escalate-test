  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        <h2 className="text-xl text-[#FF9A0E] text-center font-bold mb-4">
        ...
        <form onSubmit={onSave}>
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full p-2 rounded text-[#9E9E9E] border-0 outline-none focus:ring-0 text-sm font-extralight"
          ...
          <div className="flex justify-center space-x-2">
            <button
              type="submit"
              className="bg-yellow-500 text-white px-4 py-2 font-sm font-bold rounded flex-1 hover:bg-yellow-600 cursor-pointer"
            ...
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 text-sm text-black font-bold border rounded flex-1 cursor-pointer"
              style={{ borderColor: "#FF9A0E" }}
            >
              Cancel
            </button>
